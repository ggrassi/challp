...
public class OldJSONParserAsService extends IntentService {
	String url;
	
	public OldJSONParserAsService() {
		this("OldJSONParserAsService");
	}

	public OldJSONParserAsService(String name) {
		super(name);
	}
